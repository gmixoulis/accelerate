      ...
      <Dialog as="div" className="relative z-50" onClose={() => setAlert({...alert, show: false})}>
        ...
        <div className="fixed top-14 inset-x-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-start justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-900 text-left shadow-xl transition-all my-8 w-full sm:max-w-md">
                ...
                <div className="sm:flex">
                    <div className="mt-3 sm:ml-4 sm:mt-0 text-left flex-1">          
                      ...
                      <button>
                      <XMarkIcon className="h-5 w-5 text-gray-500  hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100 cursor-pointer" aria-hidden="true" onClick={() => {
